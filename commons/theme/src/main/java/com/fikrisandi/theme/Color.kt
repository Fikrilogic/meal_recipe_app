...
val md_theme_light_primary = Color(0xFFAA2C62)
...
val md_theme_light_surfaceTint = Color(0xFFAA2C62)
...
val md_theme_dark_primaryContainer = Color(0xFF8A0E4A)
...
val md_theme_dark_inversePrimary = Color(0xFFAA2C62)
